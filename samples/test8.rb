...
Paragraph.new(page, :border => 'dotted', :text_align => :justify, :align => 'top', :padding => '5pt', :text => "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.")
Paragraph.new(page, :border => 'dashed', :text_align => :justify, :padding => '5pt', :text => "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.")
Rectangle.new(page, :height => '0.5', :border => 'blue_dash', :corners => '0.2')
Rectangle.new(page, :height => '1.0', :border => 'red_dash', :corners => '0.2')
Rectangle.new(page, :height => '1.0', :border => 'blue_dash', :corners => '0.2')
Rectangle.new(page, :height => '0.5', :border => 'red_dash', :corners => '0.2', :align => 'bottom')
