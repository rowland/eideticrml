...
Paragraph.new(div, :align => 'left', :border => 'dotted', :text_align => :left, :width => '2in', :padding => '5pt', :text => Lorem)
Paragraph.new(div, :text_align => :justify, :padding_top => '5pt', :width => '100%', :text => Lorem)
Paragraph.new(div, :align => 'right', :border => 'dashed', :text_align => :right, :width => '2in', :padding => '5pt', :text => Lorem)
