...
page = Page.new(doc, :units => 'in', :margins => '1', :layout => 'flow')
Paragraph.new(page, :underline => true, :text => "Flow Layout")
Paragraph.new(page, :borders => 'dotted', :align => :justify, :text => "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.")
Paragraph.new(page, :border_right => 'dashed', :width => "3", :align => :justify, :text => "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.")
Paragraph.new(page, :width => "3.3", :align => :justify, :text => "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.")
Rectangle.new(page, :width => '2', :height => '1', :borders => 'blue_dash')
Rectangle.new(page, :width => '2', :height => '2', :borders => 'red_dash')
Rectangle.new(page, :width => '2', :height => '1', :borders => 'blue_dash')
Rectangle.new(page, :width => '4', :height => '0.5', :borders => 'red_dash')
Rectangle.new(page, :width => '4', :height => '0.5', :borders => 'blue_dash')
