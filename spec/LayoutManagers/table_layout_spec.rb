    ...
    describe TableLayout do
      ...
      context "russian dolls" do
        it "should nest containers inside each other" do
          div1 = Widgets::Container.new(@page, :layout => 'table', :units => :pt, :padding => 5, :cols => 1)
          div2 = Widgets::Container.new(div1,  :layout => 'table', :units => :pt, :padding => 5, :cols => 1)
          div3 = Widgets::Container.new(div2,  :layout => 'table', :units => :pt, :padding => 5, :cols => 1)
          div4 = Widgets::Container.new(div3,  :layout => 'table', :units => :pt, :padding => 5, :cols => 1)
          div5 = Widgets::Container.new(div4,  :layout => 'table', :units => :pt, :padding => 5, :cols => 1)
